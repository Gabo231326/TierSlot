    ...
    <main className="p-2">
      ...
      <section className="grid gap-4 sm:grid-cols-2">
        ...
        <div className="rounded-2xl border p-5 bg-white shadow-sm">
          ...
          <a
            href="/loyalty"
            className="inline-block mt-4 w-full text-center rounded-xl border py-2 text-sm font-semibold hover:bg-gray-50"
          >
      ...
      <section className="rounded-2xl border p-6 bg-gray-50 mt-8">
