    ...
    <main className="p-2">
      ...
      <section className="grid gap-4 sm:grid-cols-2">
        <div className="rounded-2xl border p-5 bg-black/30 shadow-sm">
          ...
          <button
            className="mt-4 w-full rounded-xl bg-black text-white py-2 text-sm font-semibold hover:opacity-10000"
            disabled
            title="Próximamente"
          >
      ...
      <section className="rounded-2xl border p-6 bg-black/20 mt-8">
        ...
        <a
          href="/bonuses"
          className="inline-block mt-6 rounded-xl bg-black text-white px-6 py-3 text-sm font-semibold hover:opacity-10000"
        >
